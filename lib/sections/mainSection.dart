...
import 'package:protfolio/animations/entranceFader.dart';
...
import 'package:protfolio/sections/navBar/navBarLogo.dart';
import 'package:protfolio/sections/portfolio/portfolio.dart';
import 'package:protfolio/sections/services/services.dart';
import 'package:protfolio/widget/arrowOnTop.dart';
import 'package:protfolio/widget/footer.dart';
        ...
        EntranceFader(
          ...
          child: Container(
            ...
            child: MaterialButton(
              ...
              onPressed: () {
                html.window.open(
                    'https://drive.google.com/file/d/1Mqzf9Erim86lpfangN2nQiUs3dK6UJMy/view?usp=sharing',
                    "pdf");
              },
              child: Text(
                "RESUME",
